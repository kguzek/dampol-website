export const TRANSLATIONS_DK = {
  ...
  model: {
    ...
    shower: "Bruser",
    kitchenStandardAnnexe: "Standard køkken anneks",
    kitchenLuxuryAnnexe: "Luksus køkken anneks (køleskab, induktionskomfur)",
    ...
    pirInsulation: "PIR isolering",
    stainlessSteelHandle: "Rustfrit stål dørhåndtag",
    softClose: "Blød lukning",
    externalLedLamp: "Ekstern LED-lampe",
    extraSocket: "Ekstra stikkontakt",
